...
public class mapPanelDoneJobController implements Initializable, MapComponentInitializedListener {
	...
	public void mapInitialized() {
		...
		for (DoneJob done : umb.getDoneJobs()) {
			
			System.out.println(done.getAdress());
			LatLong a = new LatLong(done.getAdress().getLatitude(), done.getAdress().getLongitude());
